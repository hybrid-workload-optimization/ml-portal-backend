...
--
-- Host: 210.217.178.160    Database: paas_portal
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8 COMMENT='cluster';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='코드';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='deployment';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8 COMMENT='ingress';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='ingress_controller';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=utf8 COMMENT='ingress_rule';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='job';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menu` VALUES (100000,'Dashboard','/dashboard',0,1,1,'Y'),(101000,'Project','/project/list',0,2,1,'Y'),(102000,'Cluster','/cluster/list',0,3,1,'Y'),(103000,'Workload',NULL,0,4,1,'Y'),(103010,'Deployment','/workload/deployment/list',103000,1,2,'Y'),(103020,'Stateful Set','/workload/stateful-set/list',103000,2,2,'Y'),(103030,'Pod','/workload/pod/list',103000,3,2,'Y'),(103040,'Cron Job','/workload/cron-job/list',103000,4,2,'Y'),(103050,'Job','/workload/job/list',103000,5,2,'Y'),(103060,'Replica Set','/workload/replica-set/list',103000,6,2,'Y'),(103070,'Daemon Set','/workload/daemon-set/list',103000,7,2,'Y'),(104000,'Network',NULL,0,5,1,'Y'),(104010,'Service','/network/service/list',104000,1,2,'Y'),(104020,'Ingress','/network/ingress/list',104000,2,2,'Y'),(104030,'Ingress Controller','/network/ingress-controller/list',104000,3,2,'Y'),(105000,'Config',NULL,0,6,1,'Y'),(105010,'Persistent Volume Claim','/config/persistent-volume-claim/list',105000,1,2,'Y'),(105020,'Config Map','/config/config-map/list',105000,2,2,'Y'),(105030,'Secret','/config/secret/list',105000,3,2,'Y'),(106000,'Setting',NULL,0,7,1,'Y'),(106010,'General','/setting/general',106000,1,2,'Y'),(106020,'User','/setting/user/list',106000,2,2,'Y'),(106030,'Authority','/setting/authority',106000,3,2,'Y'),(106040,'Code Management','/setting/codeMgmt',106000,4,2,'N'),(106050,'Tool','/setting/tools/detail/kubespray',106000,5,2,'Y');
...
) ENGINE=InnoDB AUTO_INCREMENT=253 DEFAULT CHARSET=utf8 COMMENT='namespace';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=utf8 COMMENT='node';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `persistent_volume`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='persistent_volume';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='persistent_volume_claim';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=32930 DEFAULT CHARSET=utf8 COMMENT='pod';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `pod_daemon_set`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=13039 DEFAULT CHARSET=utf8 COMMENT='pod_job';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=444 DEFAULT CHARSET=utf8 COMMENT='pod_persistent_volume_claim';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13038 DEFAULT CHARSET=utf8 COMMENT='pod_replica_set';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13040 DEFAULT CHARSET=utf8 COMMENT='pod_stateful_set';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=164 DEFAULT CHARSET=utf8 COMMENT='project';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 COMMENT='replica_set';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='secret';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 COMMENT='service';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8 COMMENT='service_endpoint';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='설정(General/Tools)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `setting` VALUES (1,'GENERAL','HOME_DIRECTORY','/pass-portal',NULL,NULL),(8,'TOOLS','KUBESPRAY','2.10',NULL,'2022-05-10 01:58:27');
...
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8 COMMENT='stateful_set';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='storage_class';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=173 DEFAULT CHARSET=utf8 COMMENT='사용자 알람';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='사용자_즐겨찾기';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='사용자 비밀번호 재설정 요청 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=utf8 COMMENT='사용자_역할';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16256 DEFAULT CHARSET=utf8 COMMENT='작업_이력';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=279 DEFAULT CHARSET=utf8 COMMENT='작업_Job';
/*!40101 SET character_set_client = @saved_cs_client */;
